/*
  ...
  - Added the required column `name COLLATE NOCASE` to the `Item` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_Item" (
    ...
    "name COLLATE NOCASE" TEXT NOT NULL,
    "description" TEXT,
...
CREATE UNIQUE INDEX "Item_name COLLATE NOCASE_key" ON "Item"("name COLLATE NOCASE");
