  ...
  const validateForm = () => {
    ...
    if (formData.purchaseRate !== undefined && formData.purchaseRate !== "") {
      ...
      if (isNaN(purchaseRateNum) || purchaseRateNum < 0) {
        newErrors.purchaseRate =
          "Purchase rate must be a valid positive number";
              ...
              <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={1} 
                    className="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 bg-slate-50 focus:bg-white resize-none" 
                ...
                <div>
                  ...
                  <select
                    ...
                    value={formData.unit}
                    onChange={handleInputChange}
                    className="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 bg-slate-50 focus:bg-white" 
                  >
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-4 sm:pt-6">
                  ...
                  <Link
                    href="/items"
                    className="flex-1 sm:flex-none inline-flex items-center justify-center px-5 py-2.5 bg-white text-slate-700 font-semibold rounded-xl border border-slate-300 hover:bg-slate-50 transition-all duration-200" /* Reduced padding */
                  >
                    Cancel
                  </Link>
                </div>
