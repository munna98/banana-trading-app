      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 mb-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-slate-900 mb-2">Add New Customer</h1>
              <p className="text-slate-600">Enter customer information and contact details</p>
            </div>
            <Link
              href="/customers"
        ...
        <div className="bg-blue-50 rounded-2xl border border-blue-200 p-6 mt-6">
          <div className="flex items-start">
            ...
            <div>
              <h4 className="text-sm font-semibold text-blue-900 mb-2">Tips for Adding Customers</h4>
              <ul className="text-sm text-blue-800 space-y-1">
                <li>• Customer name is required.</li>
                <li>• You can modify customer details at any time from the customer list page.</li>
                <li>• Customer balances will be automatically updated based on their transactions.</li>
              </ul>
            </div>
          </div>
        </div>
